export const typesResult: any = {
  docs: [
    {
      ...
      __dashboard: {
        ...
        transactions: [
          { label: 'Budgets', items: ['Budget'] },
          { label: 'References', items: ['Period Closing Voucher'] },
          {
  ...
  user_settings:
    '{"updated_on": "Tue Nov 01 2022 16:49:35 GMT+0800", "last_view": "List", "List": {"filters": [], "sort_by": "modified", "sort_order": "desc"}}',
};
  ...
  docs: [
    {
      ...
      modified: '2022-11-02 15:26:42.253037',
      modified_by: 'Administrator',
      docstatus: 0,
      idx: 0,
      year: '2022',
